...
class LSTMDecoder(FairseqIncrementalDecoder):
    ...
    def extract_features(
        ...
        voken = self.voken_mlp(encoder_out[0].transpose(0, 1)) # do voken on encoder's representation

        return x,  {"attn": attn_scores, 'voken': voken}
...
@register_model_architecture("voken_lstm", "voken_lstm")
...
@register_model_architecture("voken_lstm", "voken_lstm_wiseman_iwslt_de_en")
...
@register_model_architecture("voken_lstm", "voken_lstm_luong_wmt_en_de")
